...
public class FindRevisionVerificationAdapter implements FindRevisionVerificationPort {
    ...
    @Override
    public Optional<RevisionVerification> findByRevisionId(final DocumentRevisionId revisionId) {
        return verificationRequestRepository.findByDocumentRevisionId(revisionId);
    }
}
